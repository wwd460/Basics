...
#摇钱树助力
autoHelp "摇钱树好友互助码" "${logDir}/jd_moneyTree_heip.log" "MONEYTREE_SHARECODES"

#京喜农场
autoHelp "京喜农场好友互助码" "${logDir}/jd_jxnc.log" "JXNC_SHARECODES"

#城城分现金
autoHelp "城城领现金好友互助码" "${logDir}/jd_city.log" "CITY_SHARECODES"

#手机狂欢节
autoHelp "京东手机狂欢城助力好友互助码" "${logDir}/jd_carnivalcity_help.log" "JD818_SHARECODES"